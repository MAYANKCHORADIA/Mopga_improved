...
from mopga_final import run_mopga as run_mopga_final
...
ALGORITHMS = {
    ...
    "MOPGA Final": run_mopga_final,
}
POP_SIZE = 80
GENERATIONS = 100
RUNS = 5
SEEDS = [101, 202, 303, 404, 505]
RESULTS_FILE = os.path.join(os.path.dirname(__file__), "results_experiment2.json")


def print_summary_table(summary):
    """Print aggregated mean metrics for each problem and algorithm."""
    print("\nBenchmark results for Experiment 2")
    print("=" * 70)
...
def run_experiment():
    ...
    for problem_name in PROBLEMS:
        ...
        plot_pareto_fronts(problem_fronts, problem_name, save_path=f"{problem_name}_experiment2.png")
